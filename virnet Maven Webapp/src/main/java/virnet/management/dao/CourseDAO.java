...
public class CourseDAO extends BaseDAO{
	...
	public void deleteById(Serializable id) {
        super.deleteById(Course.class, id);
    }
    ...
    public Object get(Serializable id) {
    	Object o = super.get(Course.class, id);
		return o;
    }

   
	public Object getByNProperty(String... strs) {
    	Object o = super.getByNProperty(Course.class, strs);
		return o;
    }

	public Object getUniqueByProperty(String pName, Object pValue) {
    	Object o = super.getUniqueByProperty(Course.class, pName, pValue);
		return o;
    }
	...
	public Object getUniqueBySql(String sql) {
    		Object o = super.getUniqueBySql(sql, Course.class);
    	return o;
    }
	...
	public List getList() {
    	List list = super.getList(Course.class);
    	return list;
    }
	...
	public List getListByProperty(String pName,
            Object pValue) {
    	List list = super.getListByProperty(Course.class, pName, pValue);
    	return list;	    	
    }
	...
	public List getListByProperty(String pName, Object pValue, String condition) {
    	List list = super.getListByProperty(Course.class, pName, pValue, condition);
    	return list;
    }
	...
	public List getListByNProperty(String... strs) {
    	List list = super.getListByNProperty(Course.class, strs);
    	return list;
    }
	...
	public List getListBySql(String sql) {
    	List list = super.getListBySql(sql, Course.class);
    	return list;
    }
	...
	public void getListByPage(PageUtil pageUtil) {
        super.getListByPage(Course.class, pageUtil);
    }
