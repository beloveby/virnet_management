...
public class Order  implements java.io.Serializable {
	...
	private Integer orderId;
     ...
     private Integer orderClassArrangeId;
	...
	/** minimal constructor */
    public Order(Integer orderId, Integer orderSetUpUserId, Integer orderClassArrangeId) {
        this.orderId = orderId;
        this.orderSetUpUserId = orderSetUpUserId;
        this.orderClassArrangeId = orderClassArrangeId;
    }
    
    /** full constructor */
    public Order(Integer orderId, String orderSetUpDate, String orderSetUpTime, Integer orderSetUpUserId, Integer orderClassArrangeId, Integer orderExpId, Integer orderCaseResourceId, String orderStatus) {
        this.orderId = orderId;
    ...
    public Integer getOrderClassArrangeId() {
        return this.orderClassArrangeId;
    }
    
    public void setOrderClassArrangeId(Integer orderClassArrangeId) {
        this.orderClassArrangeId = orderClassArrangeId;
    }
