...
public class PeriodarrangeWeek  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8534214501659067649L;
    ...
    /** full constructor */
    public PeriodarrangeWeek(Integer periodarrangeWeekId, Integer periodarrangeWeekClassid, Integer periodarrangeWeekCabinetNum, Short periodarrangeWeekStartDay, Integer periodarrangeWeekStartTime, Short periodarrangeWeekEndDay, Integer periodarrangeWeekEndTime, Integer periodarrangeWeekSetupuserId) {
    ...
    public void setPeriodarrangeWeekCabinetNum(Integer periodarrangeWeekCabinetNum) {
        this.periodarrangeWeekCabinetNum = periodarrangeWeekCabinetNum;
    }
    ...
    public void setPeriodarrangeWeekSetupuserId(Integer periodarrangeWeekSetupuserId) {
        this.periodarrangeWeekSetupuserId = periodarrangeWeekSetupuserId;
    }
