...
public class Classgroup  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3091564324274629680L;
	...
	/** minimal constructor */
    public Classgroup(Integer classgroupId, String classgroupName) {
        this.classgroupId = classgroupId;
        this.classgroupName = classgroupName;
    }
    
    /** full constructor */
    public Classgroup(Integer classgroupId, String classgroupName, Integer classgroupTotal, String classgroupType, Integer classgroupClassId) {
        this.classgroupId = classgroupId;
        this.classgroupName = classgroupName;
