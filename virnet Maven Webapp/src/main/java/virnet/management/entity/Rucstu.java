...
public class Rucstu  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6989955854684792861L;
    ...
    /** full constructor */
    public Rucstu(Integer rucstuId, Integer rucstuUserId, String rucstuName, String rucstuSchool, String rucstuNumber, String rucstuGrade, String rucstuClass) {
        this.rucstuId = rucstuId;
        this.rucstuUserId = rucstuUserId;
