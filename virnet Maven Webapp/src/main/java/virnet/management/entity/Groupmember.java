...
public class Groupmember  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2742981812686752106L;
	...
	/** minimal constructor */
    public Groupmember(Integer classgroupmemberId, Integer classgroupmemberGroupId, Integer classgroupmemberUserId) {
    ...
    /** full constructor */
    public Groupmember(Integer classgroupmemberId, Integer classgroupmemberGroupId, Integer classgroupmemberUserId, Integer classgroupmemberLeaderFlag) {
        this.classgroupmemberId = classgroupmemberId;
        this.classgroupmemberGroupId = classgroupmemberGroupId;
        this.classgroupmemberUserId = classgroupmemberUserId;
