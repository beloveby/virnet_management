...
public class PeriodArrangeCDAO {
	...
	public List<Map<String, Object>> getDefaultWeekInfo(){
		...
		for(Periodarrange p : plist){
			...
			int classid = p.getclass().getClassId();
	...
	private Map<String, Object> processDate(Periodarrange p){
		...
		Map<String, Object> ms = this.dateutil.CalDateOneDay(this.dateutil.dateToString(p.getPeriodarrangeStartDate()));
		Map<String, Object> me = this.dateutil.CalDateOneDay(this.dateutil.dateToString(p.getPeriodarrangeEndDate()));
